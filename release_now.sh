...
echo "Committing NowPlayingScreen fixes..."
git add app/src/main/java/com/deepeye/musicpro/ui/player/NowPlayingScreen.kt
git commit -m "fix: responsive NowPlayingScreen layout to prevent cut-off controls" || echo "Already committed"
