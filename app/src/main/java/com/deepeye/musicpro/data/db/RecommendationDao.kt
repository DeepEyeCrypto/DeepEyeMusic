...
interface RecommendationDao {
    ...
    @Query("""
        ...
        LIMIT :limit
    """)
    suspend fun getTopSongsSince(since: Long, limit: Int = 20): List<SongStats>
    ...
    @Query("""
        ...
        LIMIT :limit
    """)
    suspend fun getTopArtistsSince(since: Long, limit: Int = 10): List<ArtistStats>
